...
const ApiComponent = () => {
    ...
    return (
        ...
        {translations[language]["Mainpage"]["ApiSection"]["ApiSectionDescription"]}
        </p>
        <div className="flex flex-col items-center justify-center gap-y-7">
            <div>
            <h3 className="text-white font-[500]">1. {translations[language]["Mainpage"]["ApiSection"]["Retrieve Player Data"]}</h3>
            ...
            <h3 className="text-white font-[500]">
                2. {translations[language]["Mainpage"]["ApiSection"]["All players data"]}{" "}
            </h3>
            <SyntaxHighlighter language="bash" style={style}>
                {
            ...
            <div>
            <h3 className="text-white font-[500]">
                3. {translations[language]["Mainpage"]["ApiSection"]["Get Logistical Storage (AE2, Refined Storage)"]}{" "}
            </h3>
            <SyntaxHighlighter language="bash" style={style}>
                {
            ...
            <div>
            <h3 className="text-white font-[500]">4. {translations[language]["Mainpage"]["ApiSection"]["Get item info"]} </h3>
            <SyntaxHighlighter language="bash" style={style}>
                {
            ...
            <div>
            <h3 className="text-white font-[500]">5. {translations[language]["Mainpage"]["ApiSection"]["Get author info"]} </h3>
            <SyntaxHighlighter language="bash" style={style}>
                {
            ...
            <div>
            <h3 className="text-white font-[500]">6. {translations[language]["Mainpage"]["ApiSection"]["Get mod info"]} </h3>
            <SyntaxHighlighter language="bash" style={style}>
                {
