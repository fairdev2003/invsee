    ...
    return (
        ...
        <div className="flex gap-10 justify-center mt-10">
            <div className="bg-gray-800 rounded-xl flex flex-col items-center gap-3 justify-center border-[3px] p-10 border-green-500 relative">
                ...
                <Image src={Arrow} alt="account-switch" width={80} height={80} id='arrow-2' className="absolute -top-[90px] -left-20"/>
                <p className="absolute text-white top-5 -left-[200px] max-w-[150px]">{translations[language]["Mainpage"]["AccountSection"]["ArrowTooltip"]}</p>
